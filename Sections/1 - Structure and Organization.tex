...
\begin{enumerate}
 \item
  Review the MES budget prepared by the VPF for final recommendations to the MES Council.
 \item
  Form ad-hoc committees when required for the purpose of appointing members to assist in administering the policies of the MES and undertaking new initiatives.
 \item
  Be accountable and transparent for all its actions to the MES Council and to the general membership at each General Meeting.
 \item
...
\begin{enumerate}
 \item
  ...
  \end{enumerate}
 \item
  Chair the Student Life Committee (see MES Bylaws Section \ref{student-life-committee}).
 \item
...
\begin{enumerate}
 ...
 \item
  Prepare an interim progress report and transition report (see Appendix J). % where?
 \item
  Recommend funding levels for all MES funded Clubs and Teams to the VPF and enforce the Funding Policy (see MES Bylaws Section \ref{funding-policies}).
 \item
  Assist the VPI in the allocation of Hatch Space to Clubs and Teams demonstrating essential need.
 \item
 ...
 \item
  Assist the VPSL with the organization of Back2School Week.
 \item
...
\begin{enumerate}
 ...
 \item
  ...
  \begin{enumerate}
   \item
    Act as a liaison between the MES, their respective program societies, and the students represented by those societies.
   \item
    Keep the MES informed of all program and program society issues and activities.
   \item
...
\begin{enumerate}
 ...
 \item
  The Outgoing VPF shall oversee the year-end closing and ensure the completion of the audit for their fiscal year under their purview.
 \item 
  The Outgoing President and Outgoing VPX shall attend ESSCO PM
\end{enumerate}
