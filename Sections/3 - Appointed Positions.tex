...
\begin{enumerate}
 ...
 \item
  Be responsible for organizing the following events;
  ...
  \end{enumerate}
 \item
  Be responsible for ensuring the continued operation of the Iron Ring Clock.
 \item
  Be responsible for creating new culture items that will benefit the MES, in addition to maintaining past culture items, including:
...
\begin{enumerate}
 ...
 \item
  Sit on the Election Committee (see MES Bylaws Section \ref{elections-committee}).
 \item
 ...
 \item
  ...
  \begin{enumerate}
   ...
   \item
    Selling tickets
   \item
    Organizing decorations at dinner
   \item
    Arranging speakers list
  \end{enumerate}
 \item
 ...
 \item
  ...
  \begin{enumerate}
   ...
   \item
    Arranging speakers list
   \item
    Inviting appropriate faculty guests
  \end{enumerate}
 \item
...
\begin{enumerate}
 ...
 \item
  Prepare an interim progress report and transition report (see Appendix J). % fix this lol
 \item
  Ensure all publications are reviewed by the President and the Equity, Diversity and Inclusion Officer prior to publishing.
 \item
...
\begin{enumerate}
 ...
 \item
  Promote the Intramural Funding applications, in collaboration with the VPF.
 \item
  Report to the DoE.
 \item
  Be a position held by a maximum of three people.
...
\begin{enumerate}
 ...
 \item
  Report to the VPC.
 \item
  Be a position held by a number of individuals decided at the discretion of the VPC.
...
\begin{enumerate}
 ...
 \item
  In the case that the Chief Returning Officer is elected in the Bachelor of Technology Rep or Presidential elections, they must resign from their position as Chief Returning Officer, and a new Chief Returning Officer be appointed for the remainder of the term.
 \item
  In the case that the Chief Returning Officer is elected during General Elections, they may continue in their duties as Chief Returning Officer for the remainder of the term, such that::
